...
{   
    ...
    public void SetupSword(Vector2 _dir, float _gravityScale, Player _palyer, float _freezeTimeDuration, float _returnSpeed ) { 
        player = _palyer;
        freezeTimeDuration = _freezeTimeDuration;
        returnSeep = _returnSpeed;
        rb.velocity = _dir;
